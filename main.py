...
if __name__ == '__main__':
    ...
    for args.classifier_class in classifier_classes:
        ...
        vectorizer_methods = ['OneHot', 'GloVe']

        for args.vectorizer_method in vectorizer_methods:

            dataset.update_vectorizer(args.vectorizer_method)
            ...
            if args.vectorizer_method == 'GloVe':
